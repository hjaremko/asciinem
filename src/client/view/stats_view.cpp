...
void stats_view::draw( const server::domain::game_state& state,
...
void stats_view::draw_stats( const server::domain::player& you ) const
{
    ...
    raw_window_->print( 5, 4, fmt::format( "Level:   {}", you.get_level() ) );
    raw_window_->print(
        6,
        4,
        fmt::format( "Gold:    {}", static_cast<double>( you.get_money() ) ) );
    raw_window_->print( 7, 4, fmt::format( "Attack:  {}", you.get_attack() ) );
    raw_window_->print( 8, 4, fmt::format( "Defence: {}", you.get_defense() ) );
}

void stats_view::draw_bars( const server::domain::player& you ) const
{
    raw_window_->print(
        10,
        2,
        fmt::format( "Health {}/{}", you.get_health(), you.get_max_health() ) );
    draw_red_bar( 11,
    ...
    draw_yellow_bar( 13, raw_window_->max_width() - 7, you.get_exp(), max_exp );
}

void stats_view::draw_red_bar( int y, int bars, int value, int max ) const
{
    raw_window_->set_red();
...
void stats_view::draw_yellow_bar( int y, int bars, int value, int max ) const
{
...
void stats_view::draw_bar( int y, int bars, int value, int max ) const
{
...
void stats_view::draw_eq( const server::domain::player& you ) const
{
